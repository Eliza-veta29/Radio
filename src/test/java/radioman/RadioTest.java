...
public class RadioTest {
    ...
    @ParameterizedTest
    @CsvSource({"1,2", "8,9", "9,0", "0,1", "-1,0", "10,0"})
    ...
    @ParameterizedTest
    @CsvSource({"9,9", "10,10", "-1,0", "0,0", "1,1", "100,100", "99,99", "101,0"})
    ...
    @ParameterizedTest
    @CsvSource({"99,100", "100,100", "1,2", "-1,1", "11,12", "9,10", "10,11"})
    ...
    @ParameterizedTest
    @CsvSource({"-5,5,0", "30,1,0", "30,-1,29", "30,30,29", "30,28,27", "30,29,28"})
